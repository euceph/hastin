...
class ThreadScreen(Screen):
    ...
    def __init__(
        ...
        dracula.base_style = Style(bgcolor="#0d1612")
        dracula.gutter_style = Style(color="#5e7a68")
        dracula.cursor_line_gutter_style = Style(color="#95c7a7", bgcolor="#182a1d")
        dracula.cursor_line_style = Style(bgcolor="#182a1d")
        dracula.selection_style = Style(bgcolor="#1e4a2a")
        dracula.cursor_style = Style(bgcolor="#7aab8a", color="#0e1a12")
        dracula.syntax_styles = {
            "json.label": Style(color="#87ca9b", bold=True),
